...
<body >
	...
	<h2 class="fw-bolder text-center">customer lists</h2>
	<div class="card rounded-0">
		<div class="card-body back">
			<div class="container-fluid">
				...
				<colgroup>
					...
					<tr class="headingcol">
						...
						<th class="px-2 py-1 align-middle">zipcode</th>
                        <th class="px-2 py-1 align-middle">country</th>
            ...
            <td class="px-2 py-1 align-middle"><?php echo $row['customerid']; ?></td>
						...
						<td class="px-2 py-1 align-middle text-center"><?php echo $row['email']; ?></td>
						<td class="px-2 py-1 align-middle text-center"><?php echo $row['address']; ?></p></td>
						<td class="px-2 py-1 align-middle text-center"><?php echo $row['city']; ?></td>
                        <td class="px-2 py-1 align-middle text-center"><?php echo $row['zip_code']; ?></td>
                        <td class="px-2 py-1 align-middle text-center"><?php echo $row['country']; ?></td>
					
                            <!-- <td><a class="btn btn-info" title="confirm" href="">confirm</a></td> -->
                       
                        <!-- <td><button class="btn btn-primary rounded-0" name="confirm">confirm</button></td> -->
